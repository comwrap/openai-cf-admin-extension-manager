...
async function uploadImageToAEMFromRuntime(logger, aemURL, imageDamPath, downloadedImgName, accessToken) {
  ...
  try {
    ...
    logger.log(`The file path :: ${downloadedImgName}`);
    ...
    logger.info(`ready to upload image`);
    ...
    logger.info(`Image dam path : ${aemURL}${imageDamPath} and here is the accessToken ${accessToken}`)
